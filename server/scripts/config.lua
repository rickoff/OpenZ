...
config.defaultTimeTable = { year = 2025, month = 01, day = 01, hour = 8,
    daysPassed = 1, dayTimeScale = 1, nightTimeScale = 1 }
...
config.startupScriptsInstructions = color.Red .. "Welcome to OpenZ server.\n"
...
config.instancedSpawn = {
    cellDescription = "Hospital Room 00",
    position = {4005, 4377, 12177},
    rotation = {0.3, 1.7},
    text = "Welcome to Open-Z project.",
    items = {{refId = "cloth_hosp_blouse", count = 1, charge = -1, enchantmentCharge = -1, soul = ""}}    
}
